...
# to see the all code with result open the notebookaebe58a623.ipynb
...
- generates the requested research-question outputs,
- saves figures as PDF files in `outputs/`,
- saves tables as CSV files in `outputs/`.
